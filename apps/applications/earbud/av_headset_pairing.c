...
/*甯屾湜澶勭悊鎴愬悓鏃惰繘閰嶅鐨勬儏鍐典笅锛屽彇娑堜竴涓紝鍙厑璁稿乏鑰宠繘閰嶅*/
#ifdef	LIMIT_PEER
	if(appConfigIsLeft())	{
...
{
    DEBUG_LOGF("appPairingHandsetComplete!_pairingStatus %d", status);
...
{
    DEBUG_LOGF("appHandleInternalHandsetPairCancel Pairing state=%d", appPairingGetState(thePairing));
