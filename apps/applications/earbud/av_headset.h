...
#endif
#ifdef ENABLE_SPP
    sppTaskData         spp;                   /*!< Task information for SPP support */
#endif
...
#ifdef ENABLE_SPP
/*! Get the info for the applications SPP support */
#define appGetSpp()                (&globalApp.spp)

/*! Get the Task info for the applications SPP task */
#define appGetSppTask()            (&globalApp.spp.spp_task)
#endif
