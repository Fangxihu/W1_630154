...
#ifdef	LIMIT_PEER
    bool            connected_fail;                  /*!< SCOFWD muted the local volume */
    bool            out_of_case_handle;                  /*!< SCOFWD muted the local volume */
#endif
...
#ifdef	LIMIT_PEER
        /*本机已经连接失败，发送给peer设备，换另一个连接*/
    SFWD_OTA_MSG_CONNECTED_FAIL,
#endif
};
